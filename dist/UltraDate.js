    ...
    UltraDate.prototype = {
        ...
        format: function (format, eraStrict, locale) {
            ...
            var formatting = {
                ...
                eee9: _padStart(era.year, 4),
                eee: _padSlice(era.year, 3),
                ee9: _padStart(era.year, 3),
                ee: _padSlice(era.year),
                e9: _padStart(era.year),
                e: era.year,
                EEEE: era.year === 1 && options.firstYear || _padSlice(era.year, 4),
                EEE9: era.year === 1 && options.firstYear || _padStart(era.year, 4),
                EEE: era.year === 1 && options.firstYear || _padSlice(era.year, 3),
                EE9: era.year === 1 && options.firstYear || _padStart(era.year, 3),
                EE: era.year === 1 && options.firstYear || _padSlice(era.year),
                E9: era.year === 1 && options.firstYear || _padStart(era.year),
